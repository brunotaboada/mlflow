...
[Capture only high-level constraints and considerations (avoid design solutions - these belong in Tech Spec):

- Required external integrations or existing systems to interface with
- Compliance, regulatory, or security mandates
- Performance/scalability goals (e.g., expected TPS, upper latency limits)
...
[Clearly declare what this feature will NOT include to manage scope:
